			...
			return {
				quantity: {
					fn : function ()
					{
						...
						,	max_quantity = self.model.getItem().get('maximumquantity');
						console.log("I did it!",self.model.getItem());
						...
						else if (!line_on_cart && quantity > max_quantity && max_quantity != null)
						{
							//console.log('Max Quantity error');
							return _.translate('Max quantity is $(0)', max_quantity);
						}
					}
				}
			};
