...
<div id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item" class="{{#if showGeneralClass}} {{generalClass}} {{/if}} cart-lines-row-custom">
	<section class="cart-lines-table-first">
	...
	<section class="cart-lines-table-middle">
	...
	<section class="cart-lines-table-last">
